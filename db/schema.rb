...
ActiveRecord::Schema.define(version: 2022_03_02_093453) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.integer "api_v1_post_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["api_v1_post_id"], name: "index_comments_on_api_v1_post_id"
  end
  ...
  add_foreign_key "comments", "api_v1_posts"
