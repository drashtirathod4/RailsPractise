...
ActiveRecord::Schema[7.0].define(version: 2022_05_30_091705) do
  ...
  create_table "bullet_posts", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "posts", force: :cascade do |t|
    t.integer "graphql_user_id", null: false
    t.string "title"
    t.text "body"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["graphql_user_id"], name: "index_posts_on_graphql_user_id"
  end
