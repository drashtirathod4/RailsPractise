class Api::V1::PostsController < ApplicationController
  ...
  def create
    @api_v1_post = Api::V1::Post.new(title: params[:title])
  ...
  def update
    if @api_v1_post.update(title: params[:title])
      render json: @api_v1_post, status: :ok, location: @api_v1_post
    else
      render json: @api_v1_post.errors, status: :unprocessable_entity
    end
  end
  ...
  private
    ...
    def api_v1_post_params
      params.fetch(:api_v1_post, {}).permit(:title)
    end
end
